export const SHIPS = [
  ...
  { name: 'Ironclad', manufacturer: 'Anvil', type: 'multi' },
  { name: 'Ironclad Assault', manufacturer: 'Anvil', type: 'multi' },
  { name: 'Tiburon', manufacturer: 'Anvil', type: 'multi' },
  ...
  { name: 'Pitbull', manufacturer: 'Aegis', type: 'solo' },
