export const SHIPS = [
  ...
  { name: 'Odin', manufacturer: 'Anvil', type: 'multi' },
  { name: 'Carrack', manufacturer: 'Anvil', type: 'multi' },
  { name: 'Tiburon', manufacturer: 'Aegis', type: 'multi' },
  ...
  { name: 'Ironclad', manufacturer: 'Drake', type: 'multi' },
  { name: 'Ironclad Assault', manufacturer: 'Drake', type: 'multi' },
  ...
  { name: 'Pitbull', manufacturer: 'Drake', type: 'solo' },
  ...
  { name: 'Starlite', manufacturer: 'MISC', type: 'solo' },
  ...
  { name: 'M80', manufacturer: 'Origin', type: 'solo' },
